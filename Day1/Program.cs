...
namespace Day1
{
    internal class Program
    {
        ...
        private static int GetSimpleNumberEx(string input, bool useEnglish)
        {
        ...
        private static string GetFirstDigit(string input,bool useEnglish)
        {
        ...
        private static string GetLastDigit(string input, bool useEnglish)
        {
